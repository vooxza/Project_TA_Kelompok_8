...
/// Kartu total pembayaran gradasi merah untuk halaman Pembayaran wide.
class TotalCardWide extends StatelessWidget {
  final CartController controller;
  const TotalCardWide({required this.controller});
